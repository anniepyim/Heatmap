...
class _HeatMapper(object):
    ...
    def plot(self, ax, cax, kws):
        ...
        #Annie Yim
        # Draw the heatmap
        self.mesh = ax.pcolormesh(self.plot_data, vmin=self.vmin, vmax=self.vmax,
                             cmap=self.cmap, **kws)
...
class ClusterGrid(Grid):
    ...
    def plot_colors(self, xind, yind, **kws):
        ...
        if self.row_colors is not None:
            ...
            heatmap(self,matrix, cmap=cmap, cbar=False, ax=self.ax_row_colors,
        ...
        if self.col_colors is not None:
            ...
            heatmap(self,matrix, cmap=cmap, cbar=False, ax=self.ax_col_colors,
    ...
    def plot_matrix(self, colorbar_kws, xind, yind, **kws):
        ...
        #Annie Yim
        self.heatmap = heatmap(self.data2d, ax=self.ax_heatmap, cbar_ax=self.cax,
