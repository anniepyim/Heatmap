...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        jshint: {
            files: ['gruntfile.js', 'index.js','js/**/*.js','!js/views/templates.js','!js/views/mainjs.js','!js/mpld3.v0.3.js'],
            options: {
        ...
        browserify: {
            'dist/js/Heatmap.js': ['index.js']
        },
        uglify: {
            my_target: {
                files: {
                    'dist/js/Heatmap.min.js': ['dist/js/Heatmap.js']
                }
            }
        },
        watch: {
